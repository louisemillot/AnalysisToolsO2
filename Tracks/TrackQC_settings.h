...
// const bool trackHistsAreTH3[nDatasets] = {false, false, false};
...
// const bool trackHistsAreTH3[nDatasets] = {true, true, true, true};
...
const bool trackHistsAreTH3[nDatasets] = {true, true, true, true, true, true, true, true};

const char histDrawColorsOption[12] = ",colorPairs";
