...
void Draw_TH1_Histograms(TH1** histograms_collection, Int_t collectionSize, TString* pdfName, TString* &texXtitle, TString* &texYtitle, Double_t* bins, Int_t nbins);
...
void Get_Systematics_OneCut(TH1D** hSystematicUncertainty, TH1D** hSystematicUncertainty_PreBarlow, Int_t ipart, TFile **file_O2Analysis_CutVariation_array, Int_t id_referenceAnalysis, Int_t nCutsIterations, Double_t* pTbins, Int_t nbinpT, Int_t SignalExtractionType, Int_t InvMassRebinFactor);
...
const  Int_t nCutsIterations = 2;
TFile* file_O2Analysis1 = new TFile("AnalysisResults_thinK0Speak.root");
TFile* file_O2Analysis2 = new TFile("AnalysisResults_thinK0Speak.root");
...
const Int_t SignalExtractionType = 1; //default is 1 for integration as opposed to 0 for bin counting

const Int_t numPart = 3;
const Int_t ipart = 0;
const Int_t N_SideBandSizeVariation = 4;
const Float_t SideBandSizeMultiplierModifier_array[N_SideBandSizeVariation] = {-2, -1, 0, 1};
const Int_t InvMassRebinFactor_standard = 5;
...
std::array<Double_t, 3> GetTotalAndBackgroundCount_SidebandBackgroundExtrapolation(TH1D* H1D_detectedV0s_DataLike_SmallpTinterval, Double_t SignalMean, Double_t SignalStandardDev, Double_t SideBandSizeMultiplierModifier) {
  ...
  Double_t LeftBackgroundLowerBound = SignalMean - 2*(6 + SideBandSizeMultiplierModifier)*SignalStandardDev;
  Double_t LeftBackgroundUpperBound = SignalMean - (6 + SideBandSizeMultiplierModifier)*SignalStandardDev;
  Double_t RightBackgroundLowerBound = SignalMean + (6 + SideBandSizeMultiplierModifier)*SignalStandardDev;
  Double_t RightBackgroundUpperBound = SignalMean + 2*(6 + SideBandSizeMultiplierModifier)*SignalStandardDev;
...
void Get_Systematics_OneCut(TH1D* hSystematicUncertainty, TH1D* hSystematicUncertainty_PreBarlow, Int_t ipart, TFile **file_O2Analysis_CutVariation_array, Int_t id_referenceAnalysis, Int_t nCutsIterations, Double_t* pTbins, Int_t nbinpT, Int_t SignalExtractionType, Int_t InvMassRebinFactor) {
  ...
  for(int cutsArrayIterator = 0; cutsArrayIterator < nCutsIterations; cutsArrayIterator++){
    ...
    Get_RawYield_vsPt(hRawYield_vsPt[cutsArrayIterator], H3D_DetectedV0s_MCdatalike_cutVariation[cutsArrayIterator], H1I_SelectedEventCount[cutsArrayIterator], ipart, pTbins, nbinpT, 0, -1, cutsArrayIterator, SideBandSizeMultiplierModifier_array[0], SignalExtractionType, InvMassRebinFactor); ///real line that need to take the place of the one above once it's been written
...
void Systematics_CutVariations_Graphs(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TFile** file_O2Analysis_CutVariation_array, Int_t id_referenceAnalysis, Int_t nCutsIterations, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  Int_t InvMassRebinFactor = InvMassRebinFactor_standard;

  Get_McEfficiency_vsPt(hMcEfficiency_vsPt, H3D_detectedV0s_TruePt, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, -1);
  Get_RawYield_vsPt(hRawYield_vsPt, H3D_detectedV0s_DataLike, H1I_SelectedEventCount, ipart, pTbins, nbinpT, 0, -1, 0, SideBandSizeMultiplierModifier_array[0], SignalExtractionType, InvMassRebinFactor); ///real line that need to take the place of the one above once it's been written

  // Get_Systematics_OneCut(hSystematicUncertainty_CutVariation, hSystematicUncertainty_CutVariation_PreBarlow, ipart, file_O2Analysis_CutVariation_array, id_referenceAnalysis, nCutsIterations, pTbins, nbinpT, SignalExtractionType, InvMassRebinFactor);
  ...
  leg_preBarlow->AddEntry(hSystematicUncertainty_Fit_SignalExtractionType_PreBarlow,     "SidebandVariation PreBarlow",  "LP");
  leg_preBarlow->AddEntry(hSystematicUncertainty_Fit_SidebandVariation_PreBarlow, "SignalExtractionType PreBarlow",    "LP" );
...
void Get_FeedDown(TH1D * H1D_FeedDownCorrection, Int_t ipart, TFile *file_O2Analysis, Double_t* pTbins, Int_t nbinpT) {
  ...
  TFitResultPtr fFitResult = H1D_Xsi_PtDistrib->Fit(LevisTsalisFunction_Xsipp900GeV,"S+LR"); //
...
void Draw_FeedDown(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TFile *file_O2Analysis, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  TH1D *hRawYield_vsPt;
  Int_t InvMassRebinFactor = InvMassRebinFactor_standard; //used if signalextractiontype = 1
  Get_RawYield_vsPt(hRawYield_vsPt, H3D_detectedV0s_DataLike, H1I_SelectedEventCount, ipart, pTbins, nbinpT, 0, -1, 0, SideBandSizeMultiplierModifier_array[0], SignalExtractionType, InvMassRebinFactor); ///real line that need to take the place of the one above once it's been written
...
void CorrectedYield_withSystematics(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TFile** file_O2Analysis_CutVariation_array, Int_t id_referenceAnalysis, Int_t nCutsIterations, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  Get_McEfficiency_vsPt(hMcEfficiency_vsPt, H3D_detectedV0s_TruePt, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, -1);
  Get_RawYield_vsPt(hRawYield_vsPt, H3D_detectedV0s_DataLike, H1I_SelectedEventCount, ipart, pTbins, nbinpT, 0, -1, 0, SideBandSizeMultiplierModifier_array[0], SignalExtractionType, InvMassRebinFactor); ///real line that need to take the place of the one above once it's been written
  // Get_Systematics_OneCut(hSystematicUncertainty_CutVariation, hSystematicUncertainty_CutVariation_PreBarlow, ipart, file_O2Analysis_CutVariation_array, id_referenceAnalysis, nCutsIterations, pTbins, nbinpT, SignalExtractionType);
  Get_Systematics_Fit_SideBandVariation(hSystematicUncertainty_Fit_SidebandVariation, hSystematicUncertainty_Fit_SidebandVariation_PreBarlow, ipart, H3D_detectedV0s_DataLike, H1I_SelectedEventCount, H3D_detectedV0s_TruePt, TrueV0PtSpectrum, pTbins, nbinpT, InvMassRebinFactor);
  Get_Systematics_Fit_SignalExtractionType(hSystematicUncertainty_Fit_SignalExtractionType, hSystematicUncertainty_Fit_SignalExtractionType_PreBarlow, ipart, H3D_detectedV0s_DataLike, H1I_SelectedEventCount, H3D_detectedV0s_TruePt, TrueV0PtSpectrum, pTbins, nbinpT, InvMassRebinFactor); //very large systematics as is
  ...
  hsyst = (TH1D*)hCorrectedYield_vsPt->Clone("hstat");
  ...
  *pdfName += "CorrectewdYields_O2_vs_HEPdata_vs_MCgenYield";
  // O2 MC true yield
  ...
  TH1* histograms_collection[3] = {hCorrectedYield_vsPt, hPtDiff_RawSpectrum_HEP[ipart], TrueV0PtSpectrum_rebinned};
  Draw_TH1_Histograms(histograms_collection, 3, pdfName, texXtitle, texYtitle, pTbins, nbinpT);
  // TH1* histograms_collection[2] = {hCorrectedYield_vsPt, hPtDiff_RawSpectrum_HEP[ipart]};
  // Draw_TH1_Histograms(histograms_collection, 2, pdfName, texXtitle, texYtitle, pTbins, nbinpT);

  TString* pdfName2 = new TString("");;
  *pdfName2 += "Ratio_CorrectewdYield_to_MCgenYield";
  TH1* Ratio_CorrectewdYield_to_MCgenYield;
  Ratio_CorrectewdYield_to_MCgenYield = (TH1D*)TrueV0PtSpectrum_rebinned->Clone("hstat");
  ...
  TH1* histograms_collection_2[1] = {Ratio_CorrectewdYield_to_MCgenYield};
  Draw_TH1_Histograms(histograms_collection_2, 1, pdfName, texXtitle, texYtitle, pTbins, nbinpT);
...
void Draw_TH1_Histograms(TH1** histograms_collection, Int_t collectionSize, TString* pdfName, TString* &texXtitle, TString* &texYtitle, Double_t* bins, Int_t nbins) {
  ...
  ////plots
  TCanvas *canvas = new TCanvas ("canvas", NamehistoInvMass[ipart], 1200, 800);
  ...
  // histograms_collection[0]->Draw("same");
  ...
  // histograms_collection[1]->Draw("same");
  // histograms_collection[1]->SetMarkerStyle(markers[0]);
  // histograms_collection[1]->SetMarkerColor(colors[1]);
  // histograms_collection[1]->SetLineColor(colors[1]);

  //Legend, if needed
  TLegend * leg = new TLegend(0.62, 0.6, 0.87, 0.8);
  leg->AddEntry(histograms_collection[0],     "CorrectedYield data",   "LP");
  leg->AddEntry(histograms_collection[1],     "HEP data",  "LP");
  leg->AddEntry(histograms_collection[2],     "MC gen",  "LP");
  // leg->SetFillColor(0);
  leg->SetTextSize(gStyle->GetTextSize()*0.8);
  leg->Draw("same");
