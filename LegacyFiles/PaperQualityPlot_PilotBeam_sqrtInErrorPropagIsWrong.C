...
void Get_Systematics_OneCut(TH1D* hSystematicUncertainty, TH1D* hSystematicUncertainty_PreBarlow, Int_t ipart, TFile **file_O2Analysis_CutVariation_array, Int_t nCutsIterations, Double_t* pTbins, Int_t nbinpT, Int_t InvMassRebinFactor) {
  ...
  // hCorrectedYield_vsPt[cutsArrayIterator]->Sumw2();
  // hRawYield_vsPt[cutsArrayIterator]->Sumw2();
  hCorrectedYield_vsPt_REF->Divide(hRawYield_vsPt_REF,hMcEfficiency_vsPt_REF, 1., 1., "b");
  ///////REF YIELD END /////
...
void Systematics_CutVariations_Graphs(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  hSystematicUncertainty_CutVariation_Total->Draw("E,same");
  ...
  hSystematicUncertainty_CutVariation_Total->SetMarkerStyle(markers[0]);
  ...
  hSystematicUncertainty_CutVariation_Total_PreBarlow->Draw("E,same");
  ...
  leg_preBarlow->AddEntry(hSystematicUncertainty_CutVariation_Total_PreBarlow,     "CutVariation_total PreBarlow",   "LP");
...
void Get_FeedDown(TH1D * H1D_FeedDownCorrection, Int_t ipart_option, TFile *file_O2Analysis, Double_t* pTbins, Int_t nbinpT) {
  ...
  TH2D* H2D_Feeddown_numerator_rebinned = new TH2D("H2D_Feeddown_numerator_rebinned_"+NamePart[ipart_option], "H2D_Feeddown_numerator_rebinned_"+NamePart[ipart_option], nbinpT, pTbins, nbinpT, pTbins);
  ...
  TF1* LevisTsalisFunction_Xsipp900GeV = new TF1("LevisTsalisFunction_Xsipp900GeV_"+NamePart[ipart_option], myLevyPtXsi, 0, pTbins[nbinpT], 3);
  ...
  TH1 *hFrameFeeddown = canvasFeedDown->DrawFrame(0.,0,pTbins[nbinpT],1.2*H1D_Xsi_PtDistrib_rebinned->GetMaximum());
  ...
  for(Int_t i = 1; i <= nbinpT; i++){
    ...
    for(Int_t j = 1; j <= nbinpT; j++){
      ...
      Double_t FittedYield_Xi_pTbin_j = LevisTsalisFunction_Xsipp900GeV->Integral(pTbins[j-1],pTbins[j])*1./dpT_Xi; 
      ...
      Double_t FittedYield_Xi_pTbin_j_uncertainty = sqrt(1./dpT_Xi) * LevisTsalisFunction_Xsipp900GeV->IntegralError(pTbins[j-1],pTbins[j], param, covMatrix.GetMatrixArray());
      ...
      FeedDownCorrection_i_Count_StatUncertainty = sqrt(FeedDownCorrection_i_Count_StatUncertainty*FeedDownCorrection_i_Count_StatUncertainty + hFij->GetBinError(i,j)*hFij->GetBinError(i,j) + FittedYield_Xi_pTbin_j_uncertainty*FittedYield_Xi_pTbin_j_uncertainty); //product and sums
    ...
    Double_t Feeddown_d2NdpTdy_StatUncertainty =  FeedDownCorrection_i_Count_StatUncertainty * sqrt(1./dpT*1./drapidity); //from count to yield d2N/dpTdy
...
void Draw_FeedDown_LambdaAntiLambda(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TFile *file_O2Analysis, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  H1D_FractionRawYieldRemoved_Lambda->SetMarkerColor(colors[2]);
  H1D_FractionRawYieldRemoved_Lambda->SetLineColor(colors[2]);
  ...
  H1D_FractionRawYieldRemoved_AntiLambda->SetMarkerColor(colors[2]);
  H1D_FractionRawYieldRemoved_AntiLambda->SetLineColor(colors[2]);
...
void PseudoEfficiency_O2vsHEP(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  hstat->Reset("M");
  hstat->Divide(hRawYield_vsPt,hPtDiff_RawSpectrum_HEP_rebinned, 1., 1., "b");
