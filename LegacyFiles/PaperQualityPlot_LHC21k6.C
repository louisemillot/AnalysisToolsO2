...
const Int_t SignalExtractionType_default = 0; //default is 1 for integration as opposed to 0 for bin counting; if using bin counting (0) then make sure H3D inv mass window is large enough to accomodate the 12sigma on both sides!
const Int_t InvMassRebinFactor_standard[numPart] = {20,3,3}; // I like 10 best for K0s at InvMass 0.4 to 0.6 with 400 bins, do variations around that
const Int_t N_BinningVariation = 5;
const Int_t InvMassRebinFactor_variation_array[numPart][N_BinningVariation] = {{5, 10, 2, 1, 20}, {5, 3, 6, 4, 1}, {5, 3, 6, 4, 1}};
...
// Double_t pTbins[numPart][4] = {{0., 10.},{0.6, 3.},{0.6, 3.}};
...
void PseudoEfficiency_HEPcomparison_withFit(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TFile* file_O2Analysis, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  for(int ibinPt = 1; ibinPt <= nbinpT; ibinPt++){
    ...
    H1D_DetectedV0s_O2_SmallpTinterval[iPt] = (TH1D*)H3D_DetectedV0s_O2_rebinnedZ->ProjectionZ("PseudoEfficiency_HEPcomparison_withFit_InvMass_"+NamePart[ipart]+Form("_Pt%i", ibinPt),0,-1,ibinPt_originalAxis_low,ibinPt_originalAxis_up);
...
void Get_McEfficiency_vsPt(TH1D* &hMcEfficiency_vsPt, TH3D* H3D_detectedV0s_TruePt, TH1D* TrueV0PtSpectrum, Int_t ipart, Double_t* pTbins, Int_t nbinpT, Int_t ibinXaxisCut_low, Int_t ibinXaxisCut_high, Double_t SideBandSizeMultiplierModifier, Float_t SignalMean, Float_t SignalStandardDev) {
  ...
  for(int ibinPt = 1; ibinPt <= nbinpT; ibinPt++){
    ...
    int ibinMass_signalRange_low = H1D_detectedV0s_TruePt_SmallpTinterval[iPt]->GetXaxis()->FindBin(SignalMean - (4 + SideBandSizeMultiplierModifier)*SignalStandardDev);
    int ibinMass_signalRange_up = H1D_detectedV0s_TruePt_SmallpTinterval[iPt]->GetXaxis()->FindBin(SignalMean + (4 + SideBandSizeMultiplierModifier)*SignalStandardDev);
...
std::array<Double_t, 3> GetTotalAndBackgroundCount_SidebandBackgroundExtrapolation(TH1D* H1D_detectedV0s_DataLike_SmallpTinterval, Double_t SignalMean, Double_t SignalStandardDev, Double_t SideBandSizeMultiplierModifier) {
  ...
  Double_t LeftBackgroundLowerBound = SignalMean - 2*(4 + SideBandSizeMultiplierModifier)*SignalStandardDev; // put more than 4 if possible, ie with higher magnetic field that gives thinner peak
...
void Efficiency_DcaScan(TH1D* &hstat, TH1D* &hsyst, TH1D*&hsystCorr, Int_t ipart, TFile* file_O2Analysis, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT, Double_t maxDCAcut) {
  ...
  for(Int_t ibinDcaCut = 1; ibinDcaCut <= maxDCAcutBin; ibinDcaCut++){
    ...
    Get_McEfficiency_vsPt(hMcEfficiency_vsPt[itableDcaCut], H3D_detectedV0s_TruePt_DcaHist, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, ibinDcaCut, SideBandSizeMultiplierModifier_array[0], min_range_signal[ipart], max_range_signal[ipart]);
...
void Efficiency_TpcCrossedRowsScan(TH1D* &hstat, TH1D* &hsyst, TH1D*&hsystCorr, Int_t ipart, TFile* file_O2Analysis, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT, Double_t minTpcCrossedRowscut, Double_t maxTpcCrossedRowscut) {
  ...
  for(Int_t ibinTpcCrossedRowsCut = minTpcCrossedRowscutBin; ibinTpcCrossedRowsCut <= maxTpcCrossedRowscutBin; ibinTpcCrossedRowsCut++){
    ...
    Get_McEfficiency_vsPt(hMcEfficiency_vsPt[itableTpcCrossedRowsCut], H3D_detectedV0s_TruePt_TpcCrossedRowsHist, TrueV0PtSpectrum, ipart, pTbins, nbinpT, ibinTpcCrossedRowsCut, maxTpcCrossedRowscutBin, SideBandSizeMultiplierModifier_array[0], min_range_signal[ipart], max_range_signal[ipart]);
...
void Get_Systematics_OneCut(TH1D* hSystematicUncertainty, TH1D* hSystematicUncertainty_PreBarlow, Int_t ipart, TFile **file_O2Analysis_CutVariation_array, Int_t nCutsIterations, Double_t* pTbins, Int_t nbinpT, Int_t InvMassRebinFactor) {
  ...
  Get_McEfficiency_vsPt(hMcEfficiency_vsPt_REF, H3D_DetectedV0s_MCtrue_cutVariation_REF, H1D_TrueV0PtSpectrum_cutVariation_REF, ipart, pTbins, nbinpT, 0, -1, SideBandSizeMultiplierModifier_array[0], SignalMean, SignalStandardDev);
...
void Get_Systematics_Fit_SideBandVariation(TH1D* hSystematicUncertainty, TH1D* hSystematicUncertainty_PreBarlow, Int_t ipart, TH3D* H3D_detectedV0s_DataLike, TH1I* H1I_SelectedEventCount, TH3D* H3D_detectedV0s_TruePt, TH1D* TrueV0PtSpectrum, TFile* file_O2Analysis, Double_t* pTbins, Int_t nbinpT, Int_t InvMassRebinFactor) {
  ...
  for(int id_SideBandSizeVariation = 0; id_SideBandSizeVariation < N_SideBandSizeVariation; id_SideBandSizeVariation++){
    ...
    Get_McEfficiency_vsPt(hMcEfficiency_vsPt[id_SideBandSizeVariation], H3D_detectedV0s_TruePt, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, -1, SideBandSizeMultiplierModifier_array[id_SideBandSizeVariation], SignalMean, SignalStandardDev);
...
void Get_Systematics_Fit_SignalExtractionType(TH1D* hSystematicUncertainty, TH1D* hSystematicUncertainty_PreBarlow, Int_t ipart, TH3D* H3D_detectedV0s_DataLike, TH1I* H1I_SelectedEventCount, TH3D* H3D_detectedV0s_TruePt, TH1D* TrueV0PtSpectrum, TFile* file_O2Analysis, Double_t* pTbins, Int_t nbinpT, Int_t InvMassRebinFactor) {
  ...
  for(int SignalExtractionType_loopID = 0; SignalExtractionType_loopID < N_SignalExtractionType; SignalExtractionType_loopID++){
    ...
    Get_McEfficiency_vsPt(hMcEfficiency_vsPt[SignalExtractionType_loopID], H3D_detectedV0s_TruePt, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, -1, SideBandSizeMultiplierModifier_array[0], SignalMean, SignalStandardDev);
...
void Get_Systematics_Fit_Binning(TH1D* hSystematicUncertainty, TH1D* hSystematicUncertainty_PreBarlow, Int_t ipart, TH3D* H3D_detectedV0s_DataLike, TH1I* H1I_SelectedEventCount, TH3D* H3D_detectedV0s_TruePt, TH1D* TrueV0PtSpectrum, TFile* file_O2Analysis, Double_t* pTbins, Int_t nbinpT) {
  ...
  for(int id_BinningVariation = 0; id_BinningVariation < N_BinningVariation; id_BinningVariation++){
    ...
    Get_McEfficiency_vsPt(hMcEfficiency_vsPt[id_BinningVariation], H3D_detectedV0s_TruePt, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, -1, SideBandSizeMultiplierModifier_array[0], SignalMean, SignalStandardDev);
...
void Systematics_CutVariations_Graphs(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  Get_McEfficiency_vsPt(hMcEfficiency_vsPt, H3D_detectedV0s_TruePt, TrueV0PtSpectrum, ipart, pTbins, nbinpT, 0, -1, SideBandSizeMultiplierModifier_array[0], SignalMean, SignalStandardDev);
  ...
  cout << "ETSLNTLESNLTENKSLNTLESKNELT" << endl;
  ...
  for(int ibinPt = 1; ibinPt <= nbinpT; ibinPt++){
    ...
    hSystematicUncertainty_Total->SetBinError(ibinPt,sqrt(1./2 * hSystematicUncertainty_Total->GetBinError(ibinPt) * 1./sqrt(hSystematicUncertainty_Total->GetBinContent(ibinPt))));    
    ...
    hSystematicUncertainty_Total_PreBarlow->SetBinError(ibinPt,sqrt(1./2 * hSystematicUncertainty_Total_PreBarlow->GetBinError(ibinPt) * 1./sqrt(hSystematicUncertainty_Total_PreBarlow->GetBinContent(ibinPt))));    
  }
  ...
  leg_preBarlow->AddEntry(hSystematicUncertainty_CutVariation_Total_PreBarlow,     "CutVariation PreBarlow",   "LP");
...
void Draw_FeedDownMatrix(TH1D* &hstat, TH1D* &hsyst, TH1D* &hsystCorr, Int_t ipart, TFile *file_O2Analysis, TString* SaveAs_Title, TString* &texXtitle, TString* &texYtitle, Double_t* pTbins, Int_t nbinpT) {
  ...
  TCanvas *canvasFeedDown = new TCanvas ("canvasFeedDown", NamehistoInvMass[ipart], 800, 800);
  canvasFeedDown->cd(0); //ATTENTION: +1 because canvas divide starts counting from 1
...
void Draw_TH1_Histograms_Efficiency(TH1** histograms_collection, TString** pdfLegend_collection, Int_t collectionSize, TString* pdfName, TString* &texXtitle, TString* &texYtitle, Double_t* bins, Int_t nbins, Int_t ratioOption) {
  ...
  canvas->cd(0); //ATTENTION: +1 because canvas divide starts counting from 1
  // TH1 *hFrame = canvas->DrawFrame(bins[0],0,bins[nbins],1.4*MaximumY);
  TH1 *hFrame = canvas->DrawFrame(0,0,bins[nbins],0.5);
  hFrame->SetXTitle(texXtitle->Data());
  hFrame->SetYTitle(texYtitle->Data());
  TLegend * leg = new TLegend(0.62, 0.77, 0.87, 0.87);
