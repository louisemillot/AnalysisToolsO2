...
/////////// Draw Efficiency /////////////
  ...
  TH1* histograms_collection_1[3] = {hCorrectedYield_vsPt, hPtDiff_RawSpectrum_HEP_rebinned, TrueV0PtSpectrum_rebinned};
  ...
  Draw_TH1_Histograms(histograms_collection_1, pdfLegend_collection_1, 3, pdfName1, texXtitle, texYtitle, pTbins, nbinpT, ratioOption1);
  ...
  Draw_TH1_Histograms(histograms_collection_2, pdfLegend_collection_2, 2, pdfName2, texXtitle, texYtitle, pTbins, nbinpT, ratioOption2);
