...
char prior[] = "measuredPrior";     // prior options: mcpPrior, mcdPrior, measuredPrior
char unfoldMethod[] = "Svd"; // unfolding method options: Bayes, Svd, BinByBin
...
// // pT binning for jets - gen = rec - start at 5
